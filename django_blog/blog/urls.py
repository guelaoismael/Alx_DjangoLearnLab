...
from .views import register_view,CommentDeleteView,CommentUpdateView, CommentCreateView, profile_view, CreateView, DeleteView, UpdateView, ListView, DetailView
